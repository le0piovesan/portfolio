  ...
  <section className="bg-orange-300 py-8" id="about">
    <div className="container mx-auto px-4 text-center sm:px-6 lg:mr-10 lg:items-center lg:justify-center lg:px-8 lg:text-left">
      ...
      <p className="slide-top text-base leading-relaxed">
        ...
        contributions to all sorts of projects.
        <br />
        A boring overview of my general experience: I have vast experience in
        system analysis and development, gathering and establishing
        documentation, using the Microsoft Office package, creating UML
        diagrams, and programming. I also have in-depth experience in working
        with search engines and following documentation, working in fast-paced
        environments alongside agile methodologies, designing responsive
        layouts, prototyping, debugging, working with APIs and endpoints, REST
        architecture, design patterns, SSG, SPA, and SSR applications, as well
        as managing relational and non-relational databases.
        <br />
        <br />
        Likes to play with{" "}
